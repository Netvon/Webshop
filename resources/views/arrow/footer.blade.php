...
<footer id="footer">
    <div class="container">
        ...
        <div class="col-md-3 col-sm-6">
            ...
            <a href="{{ URL::action('ArrowController@contact') }}" class="btn btn-small btn-template-main">Go to contact page</a>
...
<div id="copyright">
    <div class="container">
        <div class="col-md-12">
            <p class="pull-left">&copy; 2016. ARROW / Tom van Nimwegen & Sander Grandia</p>
